...
#new version design constrct, original truncate

def index_to_bold_file(task,run): #string,string
    #test_bold_file_L = '/tank/shared/2022/arrow_of_time/preproc6/sub-001/ses-pilot/func/sub-001_ses-pilot_task-'+task+'_acq-nordic_run-'+run+'_hemi-L_space-fsaverage_bold.func.gii'
    #test_bold_file_R = '/tank/shared/2022/arrow_of_time/preproc6/sub-001/ses-pilot/func/sub-001_ses-pilot_task-'+task+'_acq-nordic_run-'+run+'_hemi-R_space-fsaverage_bold.func.gii'
    ...
    for i in range(len(run_events)):
        if run_events[i][label_index['event_type']] == 'pulse':
            ...
            if movie == 'blank':
                ...
                if i+1 < len(run_events):
                    if run_events[i+1][label_index['event_type']] == 'movie':
                        new_time_slice = [0] * len_conditions
...
def construct_output_dir(task):
    output_dir_base = '/tank/shared/2022/arrow_of_time/arrow_of_time/aot/analysis/glmsingle/output3_pc3_poollimit'
