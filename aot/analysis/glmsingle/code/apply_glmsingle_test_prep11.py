...
def index_to_bold_file(task,run): #string,string
    test_bold_file_L = '/tank/shared/2022/arrow_of_time/preproc11/sub-001/ses-pilot/func/sub-001_ses-pilot_task-'+task+'_acq-nordic_run-'+run+'_hemi-L_space-fsaverage_bold.func.gii'
    test_bold_file_R = '/tank/shared/2022/arrow_of_time/preproc11/sub-001/ses-pilot/func/sub-001_ses-pilot_task-'+task+'_acq-nordic_run-'+run+'_hemi-R_space-fsaverage_bold.func.gii'
...
def construct_output_dir(task):
    output_dir_base = '/tank/shared/2022/arrow_of_time/arrow_of_time/aot/analysis/glmsingle/outputon11_glmautotrunc_pc3_poollimited005'
