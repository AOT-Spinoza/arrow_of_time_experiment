...
parser.add_argument("--subject", default=8, nargs="?")
parser.add_argument("--ses", default=4, nargs="?") # ses 1~8
...
def main():
    settings_dir = base_dir / core_settings["paths"]["settings_path"] / "memory_eyetracking"
    output_dir = base_dir / core_settings["paths"]["output_path"] / "memory_eyetracking"
