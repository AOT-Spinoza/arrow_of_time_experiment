...
import yaml
from session import HCPMovieELSessionLabeling
...
settings_dir = base_dir / core_settings["paths"]["settings_path"] / "labeling"
output_dir = base_dir / core_settings["paths"]["output_path"] / "labeling"
...
session_object = HCPMovieELSessionLabeling(
